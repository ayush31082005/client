    ...
    return (
        <Box sx={{ p: 4 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
                ...
                <Button variant="contained" startIcon={<RotateCcw />} onClick={fetchOrders} sx={{ bgcolor: '#C9A84C', '&:hover': { bgcolor: '#086325' } }}>
                    Refresh
                </Button>
            </Box>
            ...
            <Paper sx={{ p: 2, mb: 4, display: 'flex', gap: 2, alignItems: 'center', borderRadius: '12px' }}>
                <TextField
                    ...
                    sx={{ flexGrow: 1 }}
                    InputProps={{
                        startAdornment: <Search size={18} className="text-zinc-300 mr-2" />
                    }}
                />
                    ...
                    <TableBody>
                        {filteredOrders.map((order) => (
                            <TableRow key={order._id} hover>
                                ...
                                <TableCell sx={{ fontWeight: 'bold', color: '#C9A84C' }}>₹{order.total?.toFixed(2)}</TableCell>
                            ...
                            <Box sx={{ mt: 4 }}>
                                ...
                                <div className="space-y-3">
                                    {selectedOrder.tracking?.map((item, idx) => (
                                        <div key={idx} className="flex gap-4 items-start p-3 bg-zinc-900 rounded-lg">
            ...
            >
                ...
                <DialogContent>
                    <Typography variant="caption" sx={{ fontWeight: 700, color: '#CCCCCC', mb: 3, display: 'block', textTransform: 'uppercase', tracking: '0.1em' }}>
                ...
                <DialogActions sx={{ px: 3, pb: 2 }}>
                    <Button 
                        ...
                        sx={{ color: '#CCCCCC', fontWeight: 700, textTransform: 'uppercase', px: 3 }}
                    >
                        Cancel
                    </Button>
                    <Button 
