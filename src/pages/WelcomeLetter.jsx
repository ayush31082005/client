    ...
    return (
        <div className="mx-auto max-w-5xl bg-[#f3f4f6] px-4 py-6 md:px-6">
            <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between print:hidden">
                <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-zinc-300">My Folder</p>
                    <h1 className="mt-2 text-3xl font-black text-zinc-100">Welcome Letter</h1>
                </div>
                <button
                    onClick={handlePrint}
                    className="inline-flex items-center gap-2 rounded-md border border-yellow-800/40 bg-zinc-900 px-4 py-2 text-sm font-semibold text-zinc-200 transition hover:bg-zinc-900"
                >
                    <Download size={16} />
                    Download / Print
                </button>
            ...
            <div className="mx-auto max-w-4xl border border-yellow-800/40 bg-zinc-900 px-8 py-10 shadow-sm print:border-none print:shadow-none md:px-14 md:py-14">
                <div className="border-b border-yellow-800/40 pb-6">
                    <div className="text-center">
                        <h2 className="text-2xl font-bold uppercase tracking-[0.08em] text-zinc-100 md:text-3xl">
                            Sanyukt Parivaar & Rich Life Pvt.Ltd.
                        </h2>
                        <p className="mt-2 text-sm text-zinc-300">Welcome Letter</p>
                    </div>
                </div>

                <div className="pt-8 text-[15px] leading-8 text-zinc-100">
