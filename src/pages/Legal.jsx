...
const LegalPage = () => {
    ...
    const policies = [
        ...
        },
        {
            ...
            icon: <RefreshCw className="w-6 h-6 text-[#C9A84C]" />,
        ...
        },
        {
            ...
            icon: <Repeat className="w-6 h-6 text-[#C9A84C]" />,
        ...
        },
        {
            ...
            icon: <Megaphone className="w-6 h-6 text-[#C9A84C]" />,
    ...
    return (
        <div className="bg-[#0D0D0D] font-sans min-h-screen">
            ...
            <header className="relative h-[250px] bg-cover bg-center"
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
                    ...
                    <div className="flex items-center text-zinc-100/90 text-sm md:text-base flex-wrap justify-center">
                        ...
                        <span className="text-zinc-100">Legal</span>
                    </div>
                </div>
            </header>
            ...
            <section className="py-12 px-4 max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-[#F5F5F5] mb-4 animate-slide-up">
                    Sanyukt Parivaar & Rich Life Pvt.Ltd.
                </h2>
                <p className="text-lg text-[#C9A84C] font-medium mb-6">
                    Legal Information and Policies
                </p>
                <div className="w-[60px] h-[3px] bg-[#C9A84C] mx-auto"></div>
            </section>

            {/* Legal Disclaimer */}
            <section className="py-6 px-4 max-w-4xl mx-auto">
                <div className="bg-[#C9A84C]/10 border-l-4 border-[#C9A84C] p-6 rounded-r-lg animate-slide-right">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-8">
                    {(showAllPolicies ? policies : policies.slice(0, 4)).map((policy, index) => (
                        <button
                            ...
                            className={`w-40 p-4 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 animate-fade-in text-center group ${expandedPolicy === policy.id
                                ? 'bg-[#C9A84C] text-zinc-100'
                                : 'bg-zinc-900 hover:shadow-lg text-[#F5F5F5]'
                                }`}
                            style={{ animationDelay: `${index * 100}ms` }}
                        >
                            <div className={`flex justify-center mb-2 transition-colors ${expandedPolicy === policy.id ? 'text-zinc-100' : 'text-[#C9A84C] group-hover:text-[#C9A84C]'
                                }`}>
                                {policy.icon}
                            </div>
                            <span className={`text-xs sm:text-sm font-medium ${expandedPolicy === policy.id ? 'text-zinc-100' : 'text-[#F5F5F5]'
                                }`}>
                                {policy.title}
                            </span>
                        </button>
                    ...
                    {policies.length > 4 && (
                        <button
                            ...
                            className="w-40 p-4 rounded-lg shadow-sm border border-[#C9A84C]/20 hover:border-[#C9A84C]/50 bg-[#0D0D0D] hover:bg-[#E8F5E9] transition-all duration-300 transform hover:-translate-y-1 text-center flex flex-col items-center justify-center animate-fade-in"
                        >
                            <div className="flex justify-center mb-2 text-[#C9A84C]">
                                {showAllPolicies ? <ChevronUp className="w-6 h-6" /> : <ChevronDown className="w-6 h-6" />}
                            </div>
                            <span className="text-xs sm:text-sm font-bold text-[#C9A84C]">
            ...
            {expandedPolicy && (
                <section className="py-8 px-4 max-w-4xl mx-auto">
                    {policies.filter(p => p.id === expandedPolicy).map((policy) => (
                        <article
                            key={policy.id}
                            className="bg-zinc-900 rounded-[14px] shadow-lg overflow-hidden animate-slide-up"
                        >
                            {/* Policy Header */}
                            <div className="bg-[#C9A84C] p-6 text-zinc-100">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-zinc-900/20 rounded-full flex items-center justify-center">
                                        {React.cloneElement(policy.icon, { className: "w-6 h-6 text-zinc-100" })}
                                    </div>
                            ...
                            <div className="p-6 md:p-8">
                                    ...
                                    <div key={sectionIdx} className="mb-8 last:mb-0">
                                        ...
                                        <div className="space-y-4">
                                            {section.subSections.map((subSection, subIdx) => {
                                                ...
                                                return (
                                                    <div key={subIdx} className="border border-yellow-900/30 rounded-lg overflow-hidden">
                                                        {/* Dropdown Header */}
                                                        <button
                                                        ...
                                                        {/* Dropdown Content */}
                                                        {isExpanded && (
                                                            <div className="p-4 bg-zinc-900 border-t border-yellow-900/30">
                                                                {subSection.content && (
                                                                    <p className="text-[#F5F5F5] mb-4">{subSection.content}</p>
                                                                )}

                                                                {subSection.items && (
                                                                    <div className="space-y-4">
                                                                        {subSection.items.map((item, itemIdx) => (
                                                                            <div key={itemIdx} className="pl-4 border-l-2 border-[#C9A84C]">
                                                                                <h5 className="font-bold text-[#C9A84C] mb-1">
                                                                                    {item.subheading}
                                                                                </h5>
                                                                                <p className="text-[#F5F5F5] text-sm">
                                                                                    {item.text}
                                ...
                                <div className="mt-8 pt-6 border-t border-yellow-900/30 flex justify-end">
                                    <Link
                                        to={policy.path}
                                        className="inline-flex items-center gap-2 bg-[#C9A84C] hover:bg-[#C9A84C]/90 text-zinc-100 font-medium px-6 py-3 rounded-lg transition-colors"
                                    >
            ...
            <section className="py-12 px-4 max-w-4xl mx-auto">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-[#C9A84C] inline-block relative pb-2">
                        Official Certifications & Documents
                        <span className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-[#C9A84C]"></span>
                    </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    ...
                    <a href="/certifications/certificate_1.pdf" target="_blank" rel="noopener noreferrer"
                        className="flex flex-col items-center p-6 bg-zinc-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-yellow-900/30 group">
                        <div className="w-16 h-16 bg-[#0D0D0D] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#C9A84C] transition-colors">
                            <FileText className="w-8 h-8 text-[#C9A84C] group-hover:text-zinc-100 transition-colors" />
                        </div>
                        <h3 className="font-bold text-[#F5F5F5] text-center group-hover:text-[#C9A84C] transition-colors">Certificate of Incorporation</h3>
                        <span className="text-sm text-[#C9A84C] mt-2 flex items-center gap-1 group-hover:underline">
                    ...
                    <a href="/certifications/certificate_2.pdf" target="_blank" rel="noopener noreferrer"
                        ...
                        <h3 className="font-bold text-[#F5F5F5] text-center group-hover:text-[#C9A84C] transition-colors">Memorandum of Association</h3>
                        <span className="text-sm text-[#C9A84C] mt-2 flex items-center gap-1 group-hover:underline">
                            View PDF <ChevronRight className="w-4 h-4" />
                        </span>
                    </a>
                    ...
                    <a href="/certifications/certificate_3.pdf" target="_blank" rel="noopener noreferrer"
                        ...
                        <h3 className="font-bold text-[#F5F5F5] text-center group-hover:text-[#C9A84C] transition-colors">Articles of Association</h3>
                        <span className="text-sm text-[#C9A84C] mt-2 flex items-center gap-1 group-hover:underline">
                            View PDF <ChevronRight className="w-4 h-4" />
                        </span>
                    </a>
                    ...
                    <a href="/certifications/udyam_registration.pdf" target="_blank" rel="noopener noreferrer"
                        className="flex flex-col items-center p-6 bg-zinc-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-yellow-900/30 group">
                        <div className="w-16 h-16 bg-[#0D0D0D] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#C9A84C] transition-colors">
                            <Award className="w-8 h-8 text-[#C9A84C] group-hover:text-zinc-100 transition-colors" />
                        </div>
                        <h3 className="font-bold text-[#F5F5F5] text-center group-hover:text-[#C9A84C] transition-colors">Udyam Registration Certificate</h3>
                        <span className="text-sm text-[#C9A84C] mt-2 flex items-center gap-1 group-hover:underline">
                            View PDF <ChevronRight className="w-4 h-4" />
                        </span>
                    </a>
                    ...
                    <a href="/certifications/tan_certificate.pdf" target="_blank" rel="noopener noreferrer"
                        className="flex flex-col items-center p-6 bg-zinc-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-yellow-900/30 group">
                        <div className="w-16 h-16 bg-[#0D0D0D] rounded-full flex items-center justify-center mb-4 group-hover:bg-[#C9A84C] transition-colors">
                            <Shield className="w-8 h-8 text-[#C9A84C] group-hover:text-zinc-100 transition-colors" />
                        </div>
                        <h3 className="font-bold text-[#F5F5F5] text-center group-hover:text-[#C9A84C] transition-colors">TAN Certificate</h3>
                        <span className="text-sm text-[#C9A84C] mt-2 flex items-center gap-1 group-hover:underline">
                            View PDF <ChevronRight className="w-4 h-4" />
                        </span>
                    </a>
