...
const AboutUsPage = () => {
    ...
    return (
        <div className="bg-[#0D0D0D] font-sans">
            {/* Hero Banner Section */}
            <header className="relative h-[280px] bg-cover bg-center"
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
                    <h1 className="text-4xl md:text-5xl font-black text-zinc-100 mb-3 animate-fade-in">
                        About Us
                    </h1>
                    <div className="flex items-center text-zinc-100/90 text-sm md:text-base">
                        <span className="hover:text-zinc-100 transition-colors">Home</span>
                        <ChevronRight className="w-4 h-4 mx-2" />
                        <span className="text-zinc-100">About Us</span>
                    </div>
                </div>
            </header>
            ...
            <section className="py-8 md:py-16 px-4 max-w-7xl mx-auto text-center">
                <h2 className="text-2xl md:text-4xl font-bold text-[#C9A84C] mb-4 animate-slide-up">
                    Welcome to Sanyukt Parivaar & Rich Life Pvt.Ltd.
                </h2>
                <p className="text-lg text-[#F5F5F5] font-medium mb-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-start">
                    ...
                    <div className="space-y-6 animate-slide-right">
                        <article className="prose max-w-none">
                            <p className="text-[#F5F5F5] leading-relaxed max-w-[720px]">
                            ...
                            <p className="text-[#F5F5F5] leading-relaxed max-w-[720px] mt-4">
            ...
            <section className="py-8 md:py-16 px-4 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <article
                        className="bg-zinc-900 rounded-[14px] shadow-[0_8px_24px_rgba(0,0,0,0.08)] 
                    ...
                    >
                        ...
                        <div className="p-[30px]">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-2xl font-bold text-[#C9A84C]">Our Mission</h3>
                            </div>
                    ...
                    >
                        ...
                        <div className="p-[30px]">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-2xl font-bold text-[#C9A84C]">Our Vision</h3>
                            </div>
                            <p className="text-[#F5F5F5] leading-relaxed">
            ...
            < section className="py-8 md:py-16 px-4 max-w-7xl mx-auto" >
                <h2 className="text-2xl md:text-4xl font-bold text-center text-[#C9A84C] mb-6 md:mb-12 animate-slide-up">
                    Our Core Values
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
                    {coreValues.map((value, index) => (
                        <div
                            key={index}
                            className="bg-zinc-900 rounded-[14px] shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in overflow-hidden group"
                        ...
                        >
                            ...
                            <div className="p-6">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold text-[#C9A84C]">{value.title}</h3>
                                </div>

                                {/* Traits List */}
                                <ul className="space-y-2">
                                    {value.traits.map((trait, traitIndex) => (
                                        <li key={traitIndex} className="flex items-center gap-2 text-[#F5F5F5]">
            ...
            < section className="py-8 md:py-16 px-4 bg-zinc-900" >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center">
                        ...
                        <div className="space-y-6 animate-slide-right">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-8">
                                <div className="relative group overflow-hidden rounded-[12px] shadow-md">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-3">
                                        <span className="text-zinc-100 text-sm font-medium">Family Culture</span>
                                    </div>
                                </div>
                                <div className="relative group overflow-hidden rounded-[12px] shadow-md">
                                    <img
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-3">
                                        <span className="text-zinc-100 text-sm font-medium">Success Stories</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 mt-4">
                                <div className="flex items-center gap-2 bg-[#0D0D0D] px-4 py-2 rounded-full shadow-sm">
                        ...
                        <div className="space-y-6 animate-slide-left">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-[#0D0D0D] p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
                                    <Users className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" />
                                    <h4 className="font-bold text-[#F5F5F5] text-xl mb-1">Financial Freedom</h4>
                                    <p className="text-sm text-zinc-300">Empowering 5,000+ partners nationwide.</p>
                                </div>
                                <div className="bg-[#0D0D0D] p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
                                    <Star className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" />
                                    <h4 className="font-bold text-[#F5F5F5] text-xl mb-1">Premium Wellness</h4>
                                    <p className="text-sm text-zinc-300">100+ Natural & Ayurvedic products.</p>
                                </div>
                                <div className="bg-[#0D0D0D] p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
                                    <TrendingUp className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" />
                                    <h4 className="font-bold text-[#F5F5F5] text-xl mb-1">Success Legacy</h4>
                                    <p className="text-sm text-zinc-300">100+ successful seminars across India.</p>
                                </div>
                                <div className="bg-[#0D0D0D] p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
                                    <Shield className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" />
                                    <h4 className="font-bold text-[#F5F5F5] text-xl mb-1">Ethical Vision</h4>
                                    <p className="text-sm text-zinc-300">100% Transparent & Legal business model.</p>
                                </div>
                            </div>
            ...
            < section className="py-10 md:py-20 px-4 bg-gradient-to-r from-[#A8D5BA] to-[#C8E6C9]" >
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#C9A84C] mb-8">
                        Join a Growing Community That Believes in Shared Success
                    </h2>
                    <button
                        onClick={() => navigate('/register')}
                        className="bg-[#F9A826] hover:bg-[#F8B84A] text-zinc-100 font-bold py-4 px-10 rounded-full text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl animate-bounce-subtle"
                    >
