    ...
    return (
        <div className="p-4 md:p-6 max-w-7xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl md:text-3xl font-black text-zinc-100">Generation Wallet</h1>
                    <p className="text-sm text-zinc-300 mt-1">Manage your team repurchase earnings</p>
                </div>
            </div>

            {/* Balance Card */}
            <div className="bg-gradient-to-br from-[#C9A84C] to-[#086628] rounded-3xl p-8 mb-8 text-zinc-100 shadow-xl shadow-yellow-900/20 relative overflow-hidden">
                <div className="relative z-10">
                    <p className="text-zinc-200 font-bold uppercase tracking-widest text-xs mb-2">Available Generation Balance</p>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <button 
                             ...
                             className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-zinc-100 rounded-xl font-bold transition-all shadow-lg active:scale-95 flex items-center gap-2"
                        >
                ...
                {/* Decorative Pattern */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-zinc-900/5 rounded-full -mr-20 -mt-20 blur-3xl"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {reports.map((report, idx) => (
                    <div 
                        ...
                        className="bg-zinc-900 p-6 rounded-2xl border border-yellow-900/30 shadow-sm hover:shadow-md hover:border-yellow-100 transition-all cursor-pointer group"
                    >
                        <div className="flex items-start justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="font-black text-lg text-zinc-100">{report.title}</h3>
                                    <p className="text-sm text-zinc-300 font-medium">{report.desc}</p>
                                </div>
                            </div>
                            <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-zinc-900 p-2 rounded-lg">
