    ...
    return (
        <div className="p-4 md:p-6 max-w-7xl mx-auto bg-zinc-900 min-h-screen">
            ...
            <div ref={headerRef} className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 opacity-0">
                ...
                <div>
                    <h1 className="text-2xl md:text-3xl font-black text-zinc-100">Daily Closing Report</h1>
                    <p className="text-sm text-zinc-300 mt-1">End of day wallet summary and statistics</p>
                </div>
            </div>
            ...
            <div className="bg-zinc-900 p-4 rounded-xl border border-yellow-900/30 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <input type="date" value={selectedDate}
                        ...
                        className="px-4 py-2 border border-yellow-900/30 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500" />
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {cards.map((card, i) => (
                        <div key={i} ref={(el) => (cardsRef.current[i] = el)}
                            className="bg-zinc-900 p-4 sm:p-5 rounded-xl border border-yellow-900/30 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 opacity-0">
